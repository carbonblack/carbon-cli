...
CbcJob[]
.EXAMPLE
PS > Get-CbcJob -Id "" -Type "observation_details"
            ...
            "Id" {
                ...
                $Ids | ForEach-Object {
                    ...
                    $ExecuteServers | ForEach-Object {
                        $JobsList += Initialize-CbcJob $CurrentId $Type $_
                    }
                }
            }
        }
            ...
            if ($Endpoint) {
                ...
                if ($Response.StatusCode -ne 200) {
                    ...
                    if ($Contacted -ne $Completed) {
                        $Jobs += Initialize-CbcJob $JsonContent.job_id "Running" $_.Server
                    }
                    else {
                        $Jobs += Initialize-CbcJob $JsonContent.job_id "Completed" $_.Server
                    }
                }
            }
            else {
